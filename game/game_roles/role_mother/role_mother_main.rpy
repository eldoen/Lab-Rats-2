            ...
            if the_person.event_triggers_dict.get("Mom_forced_off_bc", False) and not pregnant_role in the_person.special_role:
                if the_person.on_birth_control:
                    ...
                    menu:
                        ...
                        "Keep her off her birth control{color=#ff0000}{size=18}Requires: $150{/size}{/color} (disabled)" if mc.has_funds(150):
                            pass
...
label mom_high_sluttiness_weekly_pay(the_person): #TODO: Change all of these over to use Actions instead of just being a menu.
    menu:
        ...
        "Stop your birth control\n{color=#ff0000}{size=18}Costs: $150{/size}{/color} (disabled)" if mc.business.has_funds(150) and the_person.effective_sluttiness() >= 30 and persistent.pregnancy_pref > 0  and not the_person.event_triggers_dict.get("Mom_forced_off_bc", False) and not pregnant_role in the_person.special_role:
            pass
