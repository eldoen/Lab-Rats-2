...
label view_onlyfans(the_person):
    if the_person.event_triggers_dict.get("onlyfans_subscription_valid_until", 0) < day: # If you haven't recently subscribed
        ...
        menu:
            ...
            "Subscribe for a day\n{color=#ff0000}{size=18}Costs: $5{/size}{/color} (disabled)" if mc.business.has_funds(5):
                pass
            ...
            "Subscribe for a month\n{color=#ff0000}{size=18}Costs: $50{/size}{/color} (disabled)" if mc.business.has_funds(20):
                pass
