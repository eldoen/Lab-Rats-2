...
label movie_date_label(the_person):
    ...
    menu:
        ...
        "Get ready for the date\n{color=#ff0000}{size=18}Requires: $50{/size}{/color} (disabled)" if mc.business.has_funds(50):
            pass
...
label dinner_date_label(the_person):
    ...
    menu:
        ...
        "Get ready for the date\n{color=#ff0000}{size=18}Requires: $30{/size}{/color} (disabled)" if mc.business.has_funds(50):
            pass
    ...
    menu:
        ...
        "A moderately priced restaurant\n{color=#ff0000}{size=18}Requires: $100{/size}{/color} (disabled)" if mc.business.has_funds(100):
            pass

        "An expensive restaurant\n{color=#ff0000}{size=18}Requires: $300{/size}{/color} (disabled)" if mc.business.has_funds(300):
            pass
...
label shopping_date_food(the_person):
    ...
    menu:
        ...
        "Pay for her lunch\n{color=#ff0000}{size=18}Costs: $40{/size}{/color} (disabled)" if mc.business.has_funds(40):
            pass
        ...
        "Just buy your own lunch\n{color=#ff0000}{size=18}Costs: $20{/size}{/color} (disabled)" if mc.business.has_funds(20):
            pass
...
label shopping_date_overwear(the_person, skip_intro = False):
    ...
    if _return:
        ...
        menu:
            ...
            "Pay for the outfit\n{color=#ff0000}{size=18}Requires: $[cost]{/size}{/color} (disabled)" if mc.business.has_funds(cost):
                pass
